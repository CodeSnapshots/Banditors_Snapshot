...
#include "GunFxConfig.generated.h"

UENUM(BlueprintType)
enum class EGunNiagaraReference : uint8
{
	ENR_NULL,
 ...
 */
UCLASS()
class PROJECTTR_API UGunFxConfig : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UNiagaraSystem* SearchNiagaraFromEnum(EGunNiagaraReference NiagaraRef) const;
