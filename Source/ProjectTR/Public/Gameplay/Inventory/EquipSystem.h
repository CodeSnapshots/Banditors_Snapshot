...
public:	
	...
	// CurrWeaponActor가 변화했을때나, 클라에서 총기 파츠를 전부 레플리케이션 완료했을때와 같이
	// 애니메이션 등에 영향을 줄 수 있는 값이 변경되었을 경우 
	// 서버, 클라에서 모두 처리하는 공통 로직
...
protected:
	...
	// 주어진 인자에 맞도록 모든 호스트의 애니메이션을 변경한다
	void Local_AdjustWeaponAnimByParam(bool bHasWeapon, bool bUseBothArms);
