...
protected:
	...
	// 콜리전에 바인딩할 함수
	UFUNCTION()
	void Server_OnAltarOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
