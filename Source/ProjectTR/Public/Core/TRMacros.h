...
/* 상태이상 위젯 */
#define ASSET_DEFAULT_STATEFF_WIDGET "UserWidget'/Game/Game/UI/WB_StatusEffect.WB_StatusEffect_C'"

/* 보스 스테이트 위젯 */
#define ASSET_DEFAULT_BOSSSTATE_WIDGET "UserWidget'/Game/Game/UI/WB_BossStateWidget.WB_BossStateWidget_C'"
#define ASSET_DEFAULT_ALLYSTATE_WIDGET "UserWidget'/Game/Game/UI/WB_AllyStateWidget.WB_AllyStateWidget_C'"
